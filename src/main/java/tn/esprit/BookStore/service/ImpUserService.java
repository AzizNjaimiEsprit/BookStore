...
public class ImpUserService implements UserService {
    ...
    private static final Logger L = LogManager.getLogger(ImpUserService.class);
    ...
    public boolean isVerified(String login, String pwd) {
        return UserRepo.isverified(login) != null;
    }

    @Override
    public boolean VerifLogin(String login, long id) {
        // TODO Auto-generated method stub
        return UserRepo.findByLogin(login, id) != null;
    }

    @Override
    public boolean exist(String login, String pwd) {
        // TODO Auto-generated method stub
        return UserRepo.existence(login, pwd);
    }
    ...
    public boolean VerifEmail(String Email, long id) {
        // TODO Auto-generated method stub
        return UserRepo.findByEmail(Email, id) != null;
    }
    ...
    public String UpdateRestPassword(int code, String password, long id) {
        ...
        if (ImpUserService.coderest == code) {
